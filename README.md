...
spec:
  ...
  currentlyExploring:
    - Cloud-native architectures and FinOps
    - Platform Engineering and Internal Developer Platforms
    - GitOps with ArgoCD and Flux
    - OpenTelemetry and eBPF-based observability
  openTo:
...
|---------|-------------|-------|
| [gitea-ansible-kubernetes](https://github.com/Invisiblelad/gitea-ansible-kubernetes) | Self-hosted Git on K8s via Ansible — IaC meets GitOps | Ansible · K8s · Helm |
| [terraform-kubernetes](https://github.com/Invisiblelad/terraform-kubernetes) | Provision and deploy full apps on K8s with Terraform | Terraform · HCL · K8s |
| [helm](https://github.com/Invisiblelad/helm) | Production-grade Helm chart for Nginx — parameterized and scalable | Helm · Docker · K8s |
| [docker-jenkins](https://github.com/Invisiblelad/docker-jenkins) | Containerized Jenkins CI — portable and pipeline-ready | Docker · Jenkins |
| [gitea](https://github.com/Invisiblelad/gitea) | Self-hosted Git service configuration and deployment manifests | Smarty · YAML |
| [webserver](https://github.com/Invisiblelad/webserver) | Lightweight web server with containerized deployment setup | HTML · Docker |
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=Invisiblelad&show_icons=true&theme=tokyonight&hide_border=true&include_all_commits=true&count_private=true&rank_icon=github)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=Invisiblelad&layout=compact&theme=tokyonight&hide_border=true&langs_count=8)
...
>
> 👉 [hashnode.com/@Sharath77](https://hashnode.com/@Sharath77)
